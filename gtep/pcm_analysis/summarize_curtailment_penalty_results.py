"""Summarize curtailment-penalty experiment outputs."""
...
def _summarize_case(case_dir: Path, cap: float | None) -> dict[str, Any]:
...
def main() -> None:
    ...
    summaries = [
        _summarize_case(case_dir, _case_price_cap(manifest, case_dir.name))
