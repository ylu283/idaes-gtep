...
def plot_binaries(dict_in, suptitle, states_order):
...
# read gen info
gens_pd = pd.read_csv("C:/Users/jkskolf/idaes-gtep/gtep/data/123_Bus_Coal/gen.csv")

this_json = read_json("./dispatchable_investments.json")
this_dict = to_dict(this_json)
states_order = ["genRetired", "genExtended", "genInstalled", "genOperational"]
plot_binaries(this_dict, "Dispatchable Investments", states_order)

this_json = read_json("./renewable_investments.json")
this_dict = to_dict(this_json)
states_order = [
    "renewableRetired",
    "renewableExtended",
...
plot_binaries(this_dict, "Renewable Investments", states_order)
